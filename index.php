...
<div class="super_container">
	...
	<div class="main_slider" style="background-image:url(images/nen3.jpg)">
		<div class="container fill_height">
			<div class="row align-items-center fill_height">
				<div class="col">
					<div class="main_slider_content">
						<h6>Bộ sưu tập 2023</h6>
						<h1 style="font-size: 50px;">Giảm giá tới 30% <br> hàng mới </h1>
						<div class="red_button shop_now_button"><a href="#sanphammoi">Sản phẩm mới</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="banner">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(images/nu.png)">
				...
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(images/banner_2.jpg)">
						<div class="banner_category">
							<a href="categories.html">Hàng khuyến mãi</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(images/nam.png)">
						<div class="banner_category">
			...
			<div class="row">
				<div class="col text-center">
					<div class="section_title new_arrivals_title">
						<div id="sanphammoi">
						<h2 style="text-align: left;">Sản phẩm mới</h2>
					</div>
					</div>
				</div>
			</div>
					...
					<div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
						...
						<div class="product-item men">
							<div class="product discount product_filter">
								<div class="product_image">
									<a href="single.html">
									<img src="images/tee2.png" alt="">
									</a>
								</div>
								<div class="favorite favorite_left"></div>
								<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Áo phong</a></h6>
						...
						<div class="product-item women">
							<div class="product product_filter">
								<div class="product_image">
									<a href="single.html">
									<img src="images/female5.png" alt="">
									</a>
								</div>
								<div class="favorite"></div>
								<div class="product_bubble product_bubble_left product_bubble_green d-flex flex-column align-items-center"><span>new</span></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Chân váy</a></h6>
						...
						<div class="product-item women">
							<div class="product product_filter">
								<div class="product_image">
									<a href="single.html">
									<img src="images/hat5.png" alt="">
									</a>
								</div>
								<div class="favorite"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Mũ len</a></h6>
						...
						<div class="product-item accessories">
							<div class="product product_filter">
								<div class="product_image">
									<img src="images/female8.png" alt="">
								</div>
								<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>sale</span></div>
								<div class="favorite favorite_left"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Áo crotop</a></h6>
						...
						<div class="product-item women men">
							<div class="product product_filter">
								...
								<div class="favorite"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Chân váy dây rút</a></h6>
						...
						<div class="product-item accessories">
							<div class="product discount product_filter">
								...
								<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
								<div class="product_info">
									<h6 class="product_name"><a href="#single.html">Áo dạ</a></h6>
									<div class="product_price">$520.00<span>$590.00</span></div>
								</div>
							</div>
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
						...
						<div class="product-item women">
							<div class="product product_filter">
								<div class="product_image">
									<img src="images/bag5.png" alt="">
								</div>
								<div class="favorite"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Túi xách da</a></h6>
									<div class="product_price">$610.00</div>
								</div>
							</div>
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
						...
						<div class="product-item accessories">
							<div class="product product_filter">
								...
								<div class="favorite"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Túi xách </a></h6>
									<div class="product_price">$120.00</div>
								</div>
							</div>
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
						...
						<div class="product-item men">
							<div class="product product_filter">
								...
								<div class="favorite favorite_left"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Quần túi hộp</a></h6>
									<div class="product_price">$410.00</div>
								</div>
							</div>
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
						...
						<div class="product-item men">
							<div class="product product_filter">
								...
								<div class="favorite"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">Áo khoác bông</a></h6>
									<div class="product_price">$180.00</div>
								</div>
							</div>
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item accessories">
									<div class="product">
										...
										<div class="favorite favorite_left"></div>
										<div class="product_info">
											<h6 class="product_name"><a href="single.html">Áo croptop</a></h6>
											<div class="product_price">$410.00</div>
										</div>
									</div>
								</div>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item women men">
									<div class="product">
										...
										<div class="favorite"></div>
										<div class="product_info">
											<h6 class="product_name"><a href="single.html">Chân váy rút dây</a></h6>
											<div class="product_price">$180.00</div>
										</div>
									</div>
								</div>
			...
			<div class="row benefit_row">
				<div class="col-lg-3 benefit_col">
					<div class="benefit_item d-flex flex-row align-items-center">
						...
						<div class="benefit_content">
							<h6>Miễn phí vận chyển</h6>
							<p>Đơn hàng trên 500.000 Đ</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 benefit_col">
				...
				<div class="col-lg-3 benefit_col">
					<div class="benefit_item d-flex flex-row align-items-center">
						...
						<div class="benefit_content">
							<h6>Giao hàng dự kiến 4-5 ngày</h6>
							<p>Hoàn trả hàng nếu sản phẩm lỗi từ nhà sản xuất</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 benefit_col">
	...
	<div id="blogs" class="blogs">
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title">
						<h2 style="text-align:left;">Blog mới nhất</h2>
					</div>
				</div>
			</div>
			<div class="row blogs_container">
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(images/xhtt1.jpg)"></div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title">Đây là xu hướng tôi thấy xuất hiện vào 2023 này</h4>
							<span class="blog_meta">Được đăng bởi quản trị viên | 12/03/2023</span>
				...
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(images/xhtt2.jpg)"></div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title">Đây là xu hướng tôi thấy xuất hiện vào 2023 này</h4>
							<span class="blog_meta">Được đăng bởi quản trị viên | 12/03/2023</span>
							<a class="blog_more" href="#">Xem thêm</a>
				...
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(images/xhtt4.jpg)"></div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title">Đây là xu hướng tôi thấy xuất hiện vào 2023 này</h4>
							<span class="blog_meta">Được đăng bởi quản trị viên | 12/03/2023</span>
							<a class="blog_more" href="#">Xem thêm</a>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="newsletter_text d-flex flex-column justify-content-center align-items-lg-start align-items-md-center text-center">
						<h4>Thông tin</h4>
						<br>
						<p>Đăng ký nhận thông tin của chúng tôi và được giảm giá 20% cho lần mua hàng đầu tiên của bạn</p>
					</div>
				</div>
				<div class="col-lg-6">
					<form action="post">
