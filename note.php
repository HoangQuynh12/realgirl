		...
		<div class="row">
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="index.html">Trang chủ</a></li>
						<li class="active"><a href="index.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Thời trang nam</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							<li><a href="#">Nam</a></li>
							<li class="active"><a href="#"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Nữ</a></li>
					...
					<div class="sidebar_section">
						...
						<ul class="checkboxes">
							...
							<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Nâu</span></li>
									...
									<ul class="product_sorting">
										<li>
											...
											<ul class="sorting_type">
												<li class="type_sorting_btn" data-isotope-option='{ "sortBy": "original-order" }'><span>Phân loại</span></li>
								...
								<div class="product-grid">
									...
									<div class="product-item men">
										<div class="product discount product_filter">
											...
											<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>520 vnđ</span></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Hoodie Nỉ</a></h6>
												<div class="product_price">520 vnđ<span>590 vnđ</span></div>
											</div>
										</div>
									...
									<div class="product-item women">
										<div class="product product_filter">
											...
											<div class="product_info">
												...
												<div class="product_price">410 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item women">
										<div class="product product_filter">
											...
											<div class="favorite"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Sweter Len Nữ</a></h6>
												<div class="product_price">120 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng </a></div>
									</div>
									...
									<div class="product-item accessories">
										<div class="product product_filter">
											...
											<div class="favorite favorite_left"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Túi du lịch đa năng</a></h6>
												<div class="product_price">310 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item women men">
										<div class="product product_filter">
											...
											<div class="favorite"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Giày cổ thấp</a></h6>
												<div class="product_price">500 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item accessories">
										<div class="product discount product_filter">
											...
											<div class="favorite favorite_left"></div>
											<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>120 vnđ</span></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Kính râm</a></h6>
												<div class="product_price">300 vnđ<span>120 vnđ</span></div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item women">
										<div class="product product_filter">
											...
											<div class="favorite"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Sweter Len Nam</a></h6>
												<div class="product_price">300 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item accessories">
										<div class="product product_filter">
											...
											<div class="favorite"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Ví cầm tay da</a></h6>
												<div class="product_price">170 vnđ</div>
											</div>
										</div>
									...
									<div class="product-item men">
										<div class="product product_filter">
											...
											<div class="favorite favorite_left"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Áo khoác kaki</a></h6>
												<div class="product_price">750 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
									...
									<div class="product-item men">
										<div class="product product_filter">
											...
											<div class="favorite"></div>
											<div class="product_info">
												<h6 class="product_name"><a href="single.html">Áo Polo tay dài</a></h6>
												<div class="product_price">200 vnđ</div>
											</div>
										</div>
										<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
									</div>
						...
						<div class="product-item accessories">
							...
							<div class="red_button add_to_cart_button"><a href="#">Thêm vào giỏ hàng</a></div>
								...
								<div class="product_sorting_container product_sorting_container_bottom clearfix">
									...
									<span class="showing_results">Hiển thị 1–3 trong số 12 kết quả</span>
									<div class="pages d-flex flex-row align-items-center">
										<div class="page_current">
											<span>1</span>
											<ul class="page_selection">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="newsletter_text d-flex flex-column justify-content-center align-items-lg-start align-items-md-center text-center">
						...
						<p>Đăng ký nhận email của chúng tôi và được giảm giá 20% cho lần mua hàng đầu tiên của bạn</p>
					</div>
				</div>
				<div class="col-lg-6">
