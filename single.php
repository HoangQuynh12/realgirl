		...
		<div class="row">
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="index.html">Trang chủ</a></li>
						<li><a href="categories.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Thời trang nam</a></li>
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Sản phẩm lẻ</a></li>
					</ul>
				</div>
		...
		<div class="row">
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="images/tee1.png" alt="" data-image="images/tee1.png"></li>
									<li class="active"><img src="images/tee.png" alt="" data-image="images/tee.png"></li>
									<li><img src="images/mauao.png" alt="" data-image="images/mauao.png"></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(images/tee.png)"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="original_price">550.000 vnđ</div>
					<div class="product_price">475.000 vnđ</div>
					...
					<div class="product_color">
						...
						<ul>
							...
							<li style="background: #030303"></li>
							<li style="background: #54a2fb"></li>
							<li style="background: #028e27"></li>
							<li style="background: #241313"></li>
						</ul>
					</div>
				...
				<div class="col">
					<div class="tabs_container">
						<ul class="tabs d-flex flex-sm-row flex-column align-items-left align-items-md-center justify-content-center">
							...
							<li class="tab" data-active-tab="tab_2"><span>Thêm thông tin</span></li>
							<li class="tab" data-active-tab="tab_3"><span>Đáng giá (2)</span></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 reviews_col">
								...
								<div class="user_review_container d-flex flex-column flex-sm-row">
									...
									<div class="review">
										<div class="review_date">12 tháng 8 2022</div>
										<div class="user_name">Hoàng Quỳnh</div>
										<p>Sản phẩm chất lượng, phù hợp với giá tiền</p>
									</div>
								</div>
